...
public class TestPortal {
    ...
    public static void main(String[] args) {
        try{
            ...
            // Use println instead of prettyPrint to get more compact output (if your
            // raw JSON is already readable)

            // Test 1: List info for a student
            prettyPrint(c.getInfo("1111111111"));
            pause();

            // Test 2: Register the student for an unrestricted course, and check that they end up registered (print info again).
            System.out.println(c.register("1111111111", "CCC111"));
            pause();
            prettyPrint(c.getInfo("1111111111"));
            pause();

            // Test 3: Register the same student for the same course again, and check that you get an error response.
            System.out.println(c.register("1111111111", "CCC111"));
            pause();

            // Test 4: Unregister the student from the course, and then unregister again from the same course.
            ...
            // Test 5: Register the student for a course that they don't have the prerequisites for, and check that an error is generated.
            System.out.println(c.register("1111111111", "CCC444"));
            pause();

            // Test 6: Unregister a student from a restricted course that they are registered to,
            ...
            // Test 7: Unregister and re-register the same student for the same restricted course,
            ...
            // Test 8: Unregister a student from an overfull course, i.e. one with more students registered than
            //     there are places on the course (you need to set this situation up in the database directly).
            ...
            // Test 9: Unregister with the SQL injection you introduced,
            //     causing all (or almost all?) registrations to disappear.
            System.out.println(c.unregister("1111111111", "attack' OR 'a'='a"));
            pause();


        } catch (ClassNotFoundException e) {
            System.err.println("ERROR!\nYou do not have the Postgres JDBC driver (e.g. postgresql-42.5.1.jar)" +
